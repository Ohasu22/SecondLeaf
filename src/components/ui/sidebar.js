...
// ---------------------- Sidebar Input, Header, Footer, Separator, Inset ----------------------
...
function SidebarGroupLabel({ className, asChild = false, ...props }) {
  ...
  return <Comp data-slot="sidebar-group-label" data-sidebar="group-label" className={cn("text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium", className)} {...props} />
}

function SidebarGroupAction({ className, asChild = false, ...props }) {
  const Comp = asChild ? Slot : "button"
  return <Comp data-slot="sidebar-group-action" data-sidebar="group-action" className={cn("absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden", className)} {...props} />
}
...
function SidebarMenuAction({ className, asChild = false, showOnHover = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden",
...
function SidebarMenuSub({ className, ...props }) {
  return <ul data-slot="sidebar-menu-sub" data-sidebar="menu-sub" className={cn("mx-3.5 flex flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5", className)} {...props} />
}
...
function SidebarMenuSubButton({ asChild = false, size = "md", isActive = false, className, ...props }) {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground flex h-7 min-w-0 items-center gap-2 overflow-hidden rounded-md px-2 outline outline-2 outline-transparent outline-offset-2 focus-visible:ring-2",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        className
      )}
