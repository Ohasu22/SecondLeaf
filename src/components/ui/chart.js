...
const ChartTooltipContent = forwardRef(
  (
    ...
    const tooltipLabel = useMemo(() => {
      ...
      return labelFormatter ? <div className={cn("font-medium", labelClassName)}>{labelFormatter(value, payload)}</div> : <div className={cn("font-medium", labelClassName)}>{value}</div>;
